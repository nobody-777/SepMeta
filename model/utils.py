...
def get_command_line_parser():
    ...
    parser.add_argument('--model_class', type=str, default='ProtoNet',
                        choices=['MatchNet', 'ProtoNet', 'BILSTM', 'MAML', 'DeepSet', 'GCN', 'FEAT', 'FEATSTAR', 'SemiFEAT', 'SemiProtoFEAT']) # None for MatchNet or ProtoNet
    ...
    parser.add_argument('--init_weights', type=str, default='./saves/initialization/miniimagenet/Res12-pre.pth')
    ...
    parser.add_argument('--lambda_spl', type=float, default=None)
    parser.add_argument('--balance_kl', type=float, default=1)
