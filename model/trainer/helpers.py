...
from model.dataloader.samplers import CategoriesSampler, RandomSampler, ClassSampler, CategoriesSampler_SPL
...
def get_dataloader_spl(args, classes):
    if args.dataset == 'MiniImageNet':
        # Handle MiniImageNet
        from model.dataloader.mini_imagenet import MiniImageNet as Dataset
    elif args.dataset == 'CUB':
    ...
    trainset = Dataset('train', args, augment=args.augment)
    args.num_class = trainset.num_class
    train_sampler = CategoriesSampler_SPL(trainset.label,
                                      num_episodes,
                                      max(args.way, args.num_classes),
                                      args.shot + args.query, classes)
